...
extension TextField {
    func uiTextfieldStyle() -> some View {
        self.padding(.bottom, 18)
    }
}

extension Font {
    static func onboardingDisplayFont() -> Font {
        return Font.custom("Markazi Text", size: 30).weight(.semibold)
    }
    
    static func displayFont() -> Font {
        return Font.custom("Karla", size: 32).weight(.semibold)
    }
    ...
    static func menuItemText() -> Font {
        return Font.custom("Karla", size: 14).weight(.medium)
    }
    
    static func menuDetailText() -> Font {
        return Font.custom("Karla", size: 21).weight(.medium)
    }
}
